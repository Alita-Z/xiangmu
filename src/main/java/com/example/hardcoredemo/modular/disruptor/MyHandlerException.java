...
public class MyHandlerException implements ExceptionHandler {
     ...
     * @see
     * com.lmax.disruptor.ExceptionHandler#handleEventException(java.lang.Throwable, long, java.lang.Object)
     */
    @Override
     ...
     * (non-Javadoc) 关闭时的异常
     * @see
     * com.lmax.disruptor.ExceptionHandler#handleOnShutdownException(java.lang.Throwable)
     */
    @Override
