package com.example.hardcoredemo.modular.tx.im.config;
...
public class TLSSigAPIv2 {
    ...
    private static String genUserSig(String userid, long expire, byte[] userbuf,long sdkappid,String key) {
        ...
        String sig =TLSSigAPIv2.hmacsha256(userid, currTime, expire, base64UserBuf,sdkappid,key);
        if (sig.length() == 0) {
            return "";
        }
     ...
     */
    public String genPrivateMapKey(String userid, long expire, long roomid, long privilegeMap,long sdkappid,String key) {
        byte[] userbuf = TLSSigAPIv2.genUserBuf(userid, roomid, expire, privilegeMap, 0, null,sdkappid);  //生成userbuf
    ...
    public String genPrivateMapKeyWithStringRoomID(String userid, long expire, String roomstr, long privilegeMap,long sdkappid,String key) {
        byte[] userbuf = TLSSigAPIv2.genUserBuf(userid, 0, expire, privilegeMap, 0, roomstr,sdkappid);  //生成userbuf
        return genUserSig(userid, expire, userbuf,sdkappid,key);
    }



    public static String hmacsha256(String identifier, long currTime, long expire,
                                    String base64Userbuf,long sdkappid,
                                    String key) {
