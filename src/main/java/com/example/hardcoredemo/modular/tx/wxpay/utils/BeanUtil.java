...
import com.example.hardcoredemo.modular.tx.wxpay.vo.WxPayOrderParam;
...
public class BeanUtil {
    ...
    public static void main(String[] args) {
        ...
        WxPayOrderParam param = new WxPayOrderParam();
        param.setAppid("124");
        ...
        System.out.println(map2Object(WxPayOrderParam.class, map).getOutTradeNo());
    }
}
